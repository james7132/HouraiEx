defmodule ParserTest do
  ...
  test "parse_channel works on names" do
    ...
    assert CommandParser.parse_channel("bot-stuff", guild) == {:ok, channel}
  end
  ...
  test "parse_role works on mentions" do
    ...
    guild = %Guild{ roles: [role] }
    assert CommandParser.parse_role("<@&274989267086868480>", guild) == {:ok, role}
  end
